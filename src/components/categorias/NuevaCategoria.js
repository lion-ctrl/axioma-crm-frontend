...
const NuevaCategoria = ({ history }) => {
    const {nuevaCategoria,mensajeproducto} = useContext(productosContext);
	...
	return (
		<Layout>
			...
			<h1 className="text-2xl text-gray-800 font-light">Nueva Categoria</h1>
